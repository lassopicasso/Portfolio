...
export const featuredArray = [
...

  {
    id: "0",
    title: "Hangman World",
    text: "Hangman game that makes geography fun. Choose a continent or the world. It use an external API with capitals around the world. If the player gets a top 10 score, it will be saved in a REST API that is built in strapi, and being displayed in the top 10-page",
