export const skillsArray = [
  ...
  {
    title: "Backend",
    text: " I've built several Rest API's through services such as Strapi and WordPress. Also have some experience with SQL from when I studied at Molde University College. Unfortunately, it's been a while. Need to strengten this knowledge before I can start implement it to larger projects. That is my goal.",
...
export const featuredArray = [
...

  {
    id: "0",
    title: "Hangman World",
    text: "Hangman game that makes geography fun. Choose a continent or the world. It use an external API that contains capitals around the world. If the player manage to get a top 10 score, it will be saved in a REST API that is built in strapi, and being displayed in the top 10-page",
